...
attachments : 
  slides_link: https://drive.google.com/open?id=0Bxzva1I0t63vWFl3MV9iXzg5M1E
...
In the script window on the upper right you should type *R* code required for the exercises. When you hit the _Submit Answer_ button, your *R* code is executed, and you get a message indicating whether your *R* code is correct. The output of your submission is shown in the *R* console on the lower right.
...
*** =instructions
In the script window on the upper right, add another line of code that calculates the product of 2 times 3, and hit the _Submit Answer_ button.
...
Comments are not run as *R* code, so they will not influence your result. For example, _Calculate 3 + 4_ in the script window on the right is a comment and is ignored during execution.

*** =instructions
Add another comment in the script window on the right, _Calculate 6 + 12_, at the appropriate location.
