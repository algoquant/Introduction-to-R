...
*** =sct
```{r}
test_output_contains("myvariable1", incorrect_msg = "Make sure to type the correct variable names without quote")
test_output_contains("myvariable2", incorrect_msg = "Make sure to type the correct variable names without quote")
...
*** =instructions
Add a line with the comment text *add comments to myvariable <- 1*, in the script window on the upper right, just above the *R* code that assigns values *myvariable1 <- 2*.
...
*** =sct
```{r}
test_output_contains("myvariable", incorrect_msg = "Make sure to type the correct variable names without quote")
test_output_contains("myvariable1", incorrect_msg = "Make sure to type the correct variable names without quote")
test_output_contains("myvariable2", incorrect_msg = "Make sure to type the correct variable names without quote")
