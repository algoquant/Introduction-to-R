...
You can also execute R commands straight in the console. When you type in the console, your submission will not be checked for correctness! Try, for example, to type in `2 * 3` and hit Enter. R should return `[1] 6`.

*** =instructions
In the script, add another line of code that calculates the product of 2 times 3, and hit the _Submit Answer_ button.
